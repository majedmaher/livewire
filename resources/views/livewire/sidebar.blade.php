    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="ads"><i
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="side1">
                                        <ul class="sidemenu-list">
                                            <li class="side-menu-label1"><a>Users</a></li>
                                            <li><a href="{{route('user.table')}}" class="slide-item"> List Users</a></li>
                                            <li><a href="{{route('home')}}" class="slide-item"> Edit User</a>
                                            </li>
                                            ...
                                            <div class="Annoucement_card">
                                                <div class="text-center">
                                                    <div>
                                                        ...
                                                        <div class="bg-layer">
                                                            <img src="../assets/../assets/images/media/37.png" alt="img"
                                        ...
                                        <div class="main-chat-list tab-pane">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user online"><img alt=""
                                                        src="../assets/images/users/9.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user"><img alt=""
                                                        src="../assets/images/users/5.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
                                            ...
                                            <div class="media border-0 px-1 new">
                                                <div class="main-img-user"><img alt=""
                                                        src="../assets/images/users/7.jpg"></div>
                                                <div class="media-body">
                                                    <div class="media-contact-name">
